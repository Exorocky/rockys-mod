package net.exorocky.rockysmod.items;
...
public class ModItems {
    ...
    //Mythril
    public static final Item MYTHRIL_INGOT = registerItem("mythril_ingot", new Item(new FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.UNCOMMON)));
